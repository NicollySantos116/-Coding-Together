...
export const atualizar = async (req, res) => {
    try {
        ...
        if (req.body.escola !== undefined) aluno.estado = req.body.escola;
        if (req.body.turma !== undefined) aluno.estado = req.body.turma;
        if (req.body.foto !== undefined) aluno.estado = req.body.foto;
